...
(async () => {
  ...
  await page.goto('https://8080-bdeebaffedbdaffabedbadaacbdaddbebebbcafb.ide.exam.ly');
  ...
  await page1.goto('https://8081-bdeebaffedbdaffabedbadaacbdaddbebebbcafb.ide.exam.ly');
